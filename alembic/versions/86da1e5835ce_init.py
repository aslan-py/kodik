...
Revision ID: 86da1e5835ce
Revises:
Create Date: 2026-07-31 17:28:40.189277
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=64), nullable=False, comment='Канал доставки: telegram, email, dashboard'),
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False, comment='Мягкое выключение записи: не участвует в выборках, из БД не удаляем'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False, comment='Название компании (например, Бегемот, Рога и Копыта)'),
    sa.Column('inn', sa.String(length=12), nullable=True, comment='ИНН конкурента (опционально, поиск по гос-реестрам)'),
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False, comment='Мягкое выключение записи: не участвует в выборках, из БД не удаляем'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=256), nullable=False, comment='Имя сайта/ресурса (например, hh.ru, авито, суд_реестр)'),
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False, comment='Мягкое выключение записи: не участвует в выборках, из БД не удаляем'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('keyword', sa.String(length=128), nullable=False, comment='Само поисковое слово/навык (например, Юрист, Python, Django, Суд)'),
    sa.Column('is_active', sa.Boolean(), server_default=sa.text('true'), nullable=False, comment='Мягкое выключение записи: не участвует в выборках, из БД не удаляем'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('domain', sa.String(length=256), nullable=False, comment='Найденный домен-кандидат. UNIQUE — не предлагать дважды'),
    sa.Column('competitor_id', sa.Integer(), nullable=True, comment='По какому конкуренту/запросу нашли'),
    sa.Column('evidence_url', sa.String(length=512), nullable=True, comment='Ссылка-доказательство: где упомянут конкурент'),
    ...
    sa.Column('moderated_by', sa.String(length=128), nullable=True, comment='Кто промодерировал'),
    ...
    sa.Column('content_hash', sa.String(length=64), nullable=True, comment='Хэш от JSON контента для сверки через Redis. NULL при status=error'),
    ...
    sa.Column('html_file_path', sa.String(length=512), nullable=True, comment='Путь к сохранённому слепку HTML на диске/S3 для истории. NULL при status=error'),
    sa.Column('source_request_url', sa.String(length=512), nullable=True, comment='Ссылка на оригинальный веб-запрос парсера. NULL при ранней ошибке'),
    ...
    sa.Column('title', sa.String(length=512), nullable=False, comment='Заголовок'),
    ...
    sa.Column('category', sa.String(length=128), nullable=False, comment='Категория (category.name)'),
    sa.Column('tonality', sa.String(length=32), nullable=False, comment='Тональность'),
    sa.Column('media_index', sa.Numeric(precision=10, scale=2), nullable=True, comment='Медиаиндекс'),
    sa.Column('action', sa.String(length=512), nullable=True, comment='Требуемое действие'),
    ...
    sa.Column('task', sa.String(length=512), nullable=False, comment='Задача: что конкретно сделать (решение человека)'),
