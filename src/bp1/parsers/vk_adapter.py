"""
Адаптер для dev.vk.com, реализующий интерфейс BaseParser.
...
class VKAdapter(BaseParser):
    """Адаптер-заглушка для VK API."""

    def __init__(self, **kwargs):
        logger.info('Инициализация VKAdapter')

    async def parse(self, url: str, **kwargs) -> ParsedResponse:
        logger.info('Выполняется модуль парсинга: dev.vk.com')
